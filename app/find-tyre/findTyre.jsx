...
const FindTyre = ({ pageDataFromParent }) => {
  ...
  useEffect(() => {
    ...
    console.log("pageDataFromParent", pageDataFromParent);
  }, [activeTab]);
      ...
      <>
        ...
        <SchemaOrg
          schema={{
            ...
            "@type": "Organization",
            name: pageDataFromParent.data?.attributes?.seo_title,
            url: domain + pageDataFromParent.data?.attributes?.permalink,
            logo: getStrapiMedia(pageDataFromParent?.seo_image?.url),
            description: pageDataFromParent.seo_description,
          }}
        />
        <Navbar />
