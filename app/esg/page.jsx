  ...
  return (
    <>
      ...
      <section className="mt-[60px]">
        <Image src={Separator} alt="Hero-Banner" className="w-full h-full object-cover" />
      </section>
      <section className="page-content-sec mt-[60px]">
        <div className="container mx-auto flex flex-col gap-10">
          ...
          <div>
            <div className="flex justify-between text-[#4F5662] ">
              <button className={`w-1/4 flex flex-col items-start gap-5 pb-5 ${activeTab === "tab-1" ? "border-b-[6px] border-[#2E3192] !text-[#1A202C]" : ""}`} onClick={() => setActiveTab("tab-1")}>
                <h2 className="text-[32px] font-semibold leading-[38.4px]">Planet</h2>
                <p className="text-left w-4/5">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
              </button>
              <button className={`w-1/4 flex flex-col items-start gap-5 pb-5 ${activeTab === "tab-2" ? "border-b-[6px] border-[#2E3192] !text-[#1A202C]" : ""}`} onClick={() => setActiveTab("tab-2")}>
                <h2 className="text-[32px] font-semibold leading-[38.4px]">Communities</h2>
                <p className="text-left w-4/5">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
              </button>
              <button className={`w-1/4 flex flex-col items-start gap-5 pb-5 ${activeTab === "tab-3" ? "border-b-[6px] border-[#2E3192] !text-[#1A202C]" : ""}`} onClick={() => setActiveTab("tab-3")}>
                <h2 className="text-[32px] font-semibold leading-[38.4px]">People</h2>
                <p className="text-left w-4/5">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
              </button>
              <button className={`w-1/4 flex flex-col items-start gap-5 pb-5 ${activeTab === "tab-4" ? "border-b-[6px] border-[#2E3192] !text-[#1A202C]" : ""}`} onClick={() => setActiveTab("tab-4")}>
                <h2 className="text-[32px] font-semibold leading-[38.4px]">Governance</h2>
                <p className="text-left w-4/5">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
              </button>
            </div>
            {activeTab === "tab-1" && (
              <div className="bg-[#F4F5F6] flex flex-col text-[#4F5662] gap-6 p-10 !pt-6 rounded-b-xl">
                ...
                <div className="flex justify-between gap-[35px]">
                  <figure className="w-1/3">
                    <Image src={Man1} alt="Hero-Banner" className="rounded-xl w-full h-[250px] object-cover" />
                  </figure>
                  <figure className="w-1/3">
                    <Image src={Man2} alt="Hero-Banner" className="rounded-xl w-full h-[250px] object-cover" />
                  </figure>
                  <figure className="w-1/3">
                    <Image src={Man3} alt="Hero-Banner" className="rounded-xl w-full h-[250px] object-cover" />
                  </figure>
                </div>
              </div>
            )}
