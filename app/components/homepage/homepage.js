...
export default function Homepage() {
  ...
  return (
    <>
      ...
      <Sustainability Heading={pageData.data?.attributes?.section4_heading} Title={pageData.data?.attributes?.section4_title} Description={pageData.data?.attributes?.section4_description} Video={pageData.data?.attributes?.section4_video}/>
      <AboutUs Data={pageData.data?.attributes?.section5}/>
      <Media Heading={pageData.data?.attributes?.media_heading} Title={pageData.data?.attributes?.media_title}/>
      <Faq Heading={pageData.data?.attributes?.blog_heading} Title={pageData.data?.attributes?.blog_title} Data={pageData.data?.attributes?.faq}/>
