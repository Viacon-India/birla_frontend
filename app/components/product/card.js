...
export default function SectionSelection({type,load="--",pattern="--",construction="--",productImage,productName,productDescription,icon,sizes}){
    return(
            ...
            <div class="flex gap-8 px-4 pt-4">
                <div class="new-product-iconListSec flex flex-col gap-6 2xl:gap-10">
                    <div class="flex gap-[6px] items-center">
                        ...
                        <span>
                            <p class="text-[18px] font-semibold !text-[#727C8D] !mb-0">Load Type</p>
                    ...
                    <div class="flex gap-[6px] items-center">
                        ...
                        <span>
                            <p class="text-[18px] font-semibold !text-[#727C8D] !mb-0">Pattern</p>
                    ...
                    <div class="flex gap-[6px] items-center">
                        ...
                        <span>
                            <p class="text-[18px] font-semibold !text-[#727C8D] !mb-0">Construction</p>
