...
export function SingleTypeSeo({pageData, page='page'}){
  ...
  return(
    <Helmet>
      ...
      {pageData.data?.attributes.seo_image?.data && <meta property="og:image:width" content={pageData.data.attributes.seo_image.data.attributes?.width} />}
      {pageData.data?.attributes.seo_image?.data && <meta property="og:image:height" content={pageData.data.attributes.seo_image.data.attributes?.height} />}
      {pageData.data?.attributes.seo_image?.data && <meta property="og:image:type" content={pageData.data.attributes.seo_image.data.attributes?.mime} />}
...
export function CollectionTypeSeo({page, pageData}){
  ...
  return(
    <Helmet>
      ...
      {pageData?.seo_image && <meta property="og:image:width" content={pageData.seo_image?.width} />}
      {pageData?.seo_image && <meta property="og:image:height" content={pageData.seo_image?.height} />}
      {pageData?.seo_image && <meta property="og:image:type" content={pageData.seo_image?.mime} />}
