    ...
    <>
      {headerData.data?.attributes &&
        <>
          <div className="nav-main">
              ...
              <div className="md:py-4 xl:py-0 w-full flex justify-between items-center relative">
                <div class="flex items-center">
                  ...
                  <div className="navbar-center flex items-center gap-6 lg:flex pl-3 xl:pl-7 ml-[-10%] md:ml-0">
                    <ul className="menu menu-horizontal hidden xl:flex relative text-lg lg:gap-4 2xl:gap-7 p-0">
                      {headerData.data.attributes.menus.data[0].attributes?.menu.map((menu) => (
                      ...
                      {headerData.data.attributes.menus.data[0].attributes?.segments?.data.map((menu) => (
                        <li className="nav-drop group" key={menu.id}>
                          <Link
                            className="nav-links nav-hov flip-animate"
                            href={`${menu.attributes.permalink}`}
                      ...
                      {headerData.data.attributes.menus.data[0].attributes?.pages?.data.map((menu) => (
                        <li className="nav-drop group" key={menu.id}>
                          <Link
                            className="nav-links nav-hov flip-animate"
                            href={`${menu.attributes.permalink}`}
                      ...
                      {headerData.data.attributes.menus.data[0].attributes?.other_link.map((menu) => (
                        <li className="nav-drop group" key={menu.id}>
                          <Link
                            className="nav-links nav-hov flip-animate"
                            href={`${menu.link}`}
                ...
                {headerData.data.attributes.logo.length > 1 && (
                  <div className="navbar-end gap-2 md:gap-3 group flex justify-end items-center py-1 md:py-0">
                    {headerData.data.attributes.logo[0].image?.data && headerData.data.attributes.logo[0].icon_link?.link && (
                      <Link href={headerData.data.attributes.logo[0].icon_link.link} target="_blank">
                        <figure className="rounded-none m-0 w-[50px] h-[50px] md:w-[65px] md:h-[65px]">
                          <Image
                            src={getStrapiMedia(
                              headerData.data.attributes.logo[0].image.data.attributes.url
                            )}
                            width={headerData.data.attributes.logo[0].image.data.attributes.width}
                            height={headerData.data.attributes.logo[0].image.data.attributes.height}
                            alt={headerData.data.attributes.logo[0].image.data.attributes?.alternativeText}
                    ...
                    {headerData.data.attributes.logo[1].image?.data && headerData.data.attributes.logo[1].icon_link?.link && (
                      <Link href={headerData.data.attributes.logo[1].icon_link.link}>
                        <figure className="rounded-none m-0 w-[80px] h-[35px] md:w-[136px] md:h-[60px]">
                          <Image
                            src={getStrapiMedia(
                              headerData.data.attributes.logo[1].image.data.attributes.url
                            )}
                            width={headerData.data.attributes.logo[1].image.data.attributes.width}
                            height={headerData.data.attributes.logo[1].image.data.attributes.height}
                            alt={headerData.data.attributes.logo[1].image.data.attributes?.alternativeText}
            ...
            >
              ...
              <div className="dropdown-wrapper">
                <div class={cn("search-wrapper relative flex md:hidden my-[3px] mx-2 ", isActive ? 'active' : '')} onClick={handleToggle}>
                  <input
                    className="search-input"
                    type="text"
                    placeholder="Search website"
                ...
                <ul className="h-full overflow-auto px-[16px] pt-4 md:pt-0 xl:pt-[80px] 2xl:!pt-0 border-t-2 md:border-t-0">
                  {headerData.data.attributes.menus.data[1].attributes?.menu.map((menu) => (
                  ...
                  {headerData.data.attributes.menus.data[1].attributes?.segments?.data.map((menu) => (
                    <li className="mb-4" key={menu.id}>
                      <Link
                        className="ham-links"
                        href={`${menu.attributes.permalink}`}
                  ...
                  {headerData.data.attributes.menus.data[1].attributes?.pages?.data.map((menu) => (
                    <li className="mb-4" key={menu.id}>
                      <Link
                        className="ham-links"
                        href={`${menu.attributes.permalink}`}
                  ...
                  {headerData.data.attributes.menus.data[1].attributes?.other_link.map((menu) => (
                    <li className="mb-4" key={menu.id}>
          ...
          {headerData.data.attributes?.float && headerData.data.attributes.float.length > 0 &&
